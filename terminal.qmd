...
Once the password is successfully updated, you will be logged into the HPC system and will see the command-line prompt.
...
![Example SSH login to the HPC cluster](terminal-images/pwd.png){width=80%}
...
### Simple training method (change directory)
...
If you have a script file (for example a shell script), you can run it using:


After that, the script can be executed using:
